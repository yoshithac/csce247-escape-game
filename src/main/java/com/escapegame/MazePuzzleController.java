...
public class MazePuzzleController implements Initializable {
    ...
    private final File SAVE_FILE = new File(System.getProperty("user.home"), ".escapegame_maze.properties");
    ...
    public void initialize(URL location, ResourceBundle resources) {
        System.out.println("MazePuzzleController.initialize() start");
        ...
        System.out.println("MatchingPuzzleController.initialize() done");
    }
