...
public class RiddlePuzzleController implements Initializable {
    ...
    private void onSubmit() {
        ...
        boolean processed = game.processInput(raw.trim());
        Map<String, Object> state = game.getGameState();
        if (game.isGameOver()) {
            ...
            if (won) {
                ...
                String nextScene = "";
                Map<String, Object> cfg = com.model.WordPuzzleGame.configFor(puzzleType, difficulty);
                if (cfg != null) nextScene = (String) cfg.getOrDefault("nextScene", "");
                ...
                statusLabel.setText("Out of attempts. The correct answer was: \"" + result.getOrDefault("answer", "") + "\".");
                btnSubmit.setDisable(true);
                answerField.setDisable(true);
    ...
    @FXML
    private void onHint() {
        boolean processed = game.processInput("HINT");
        Map<String, Object> state = game.getGameState();
